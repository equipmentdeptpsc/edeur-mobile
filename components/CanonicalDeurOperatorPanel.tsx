...
export function CanonicalDeurOperatorPanel() {
  const { canonicalWork: work, canonicalWorks, selectCanonicalWork, canonicalBusy, offlineSyncState, offlinePendingCount, startCanonicalDeur, transitionCanonicalActivity, endCanonicalShift, submitCanonicalDeur, acceptCanonicalTurnover } = useAuth();
